...
/*
Project: Wifi controlled LED matrix display with MQTT subscriber - for attaching to local LAN.  Has wifi based setup on first run.
...
/*
  ...
  constructs the strings that can be sent to the led display
*/
void handle_msg() {
...
//ESP.wdtDisable();                               // used to debug, disable wachdog timer, 
  ...
  wifiManager.autoConnect("Setup Marquee");
